...
if(isset($_POST["addToProduct"])){
	...
	$count = mysqli_fetch_array($run_query);
		...
		echo "<div class='alert alert-danger'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Product is already added to the cart!!</b>
			...
			$pro_image = $row["product_image"];
			$pro_price = $row["product_price"];
			$sql="INSERT INTO `cart` (`id`, `p_id`, `ip_add`, `user_id`, `product_name`, `product_image`, `qty`, `price`, `total`) VALUES (NULL, '$p_id', '0', '$user_id', '$pro_name', '$pro_image','1', '$pro_price',  '$pro_price')";
		...
		echo "<div class='alert alert-success'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Please log in first!!</b>
...
if(isset($_POST["get_cart_product"])||isset($_POST["cart_checkout"])){
	...
	if($count >0){
			...
			if(isset($_POST["get_cart_product"])){
					echo "
							<div class='row'>
									...
									<div class='col-md-3'><img src='images/$pro_image' width='50px' height='60px'></div>
		...
		if(isset($_POST["cart_checkout"])){
			...
			echo "      <div class='row'>
							...
							<div class='col-md-4'>
								<h1><b>Grand TOTAL $.$total_amt</b></h1>
							</div>
						</div>";
		}
				echo '<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				  <input type="hidden" name="cmd" value="_cart">
				  <input type="hidden" name="business" value="niharcart@gmail.com">
				...
				echo '  <input  style="float:right;margin-right:20px;"type="image" name="submit"
					src="https://www.paypalobjects.com/webstatic/en_US/i/btn/png/blue-rect-paypalcheckout-60px.png" alt="PayPal Chechout
	...
	if(isset($_POST["removeFromCart"])){
		...
		if($run_query){
			echo "<div class='alert alert-danger'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Product is Removed From the cart!!</b>
	...
	if(isset($_POST["updateProduct"])){
		...
		$price= $_POST["price"];
		$total= $_POST["total"];
		$sql = "UPDATE cart SET qty='$qty', price='$price',total='$total' WHERE user_id='$uid' AND p_id= '$pid'";
		$run_query = mysqli_query($con,$sql);
		if($run_query){
			echo "<div class='alert alert-success'>
